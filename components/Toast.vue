<template>
     <div v-show="open">
    <div class="inline-flex min-w-80 w-full min-h-[2.4rem] px-4 py-2 rounded-sm text-sm text-white" :class="typeColor(type)">
      <div class="flex w-full justify-between items-start">
        ...
        <button class="opacity-70 hover:opacity-80 ml-3 mt-[3px]" @click="open = false; clearToasts()">
...
export default {
  ...
  setup() {
    ...
    const clearToasts = () => {
        useState('success').value = '';
        useState('errors').value = [];
    }    
    return {
      typeColor,
      clearToasts
