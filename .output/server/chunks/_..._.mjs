import { createError, readBody, useBase, createRouter, defineEventHandler } from 'h3';
...
const detail$2 = async (evt) => {
  var _a;
  try {
    const result = await detail$3(
      (_a = evt.context.params) == null ? void 0 : _a.id_cliente
    );
    return {
      data: result
    };
...
const detail = async (evt) => {
  ...
  try {
    const result = await detail$1(
      (_a = evt.context.params) == null ? void 0 : _a.id_inspector
    );
    return {
      data: result
    };
...
router.get("/cliente", defineEventHandler(read$2));
router.post("/cliente", defineEventHandler(create$2));
router.get("/cliente/:id_cliente", defineEventHandler(detail$2));
router.put("/cliente/:id_cliente", defineEventHandler(update$2));
router.delete("/cliente/:id_cliente", defineEventHandler(remove$2));
router.get("/inspector", defineEventHandler(read));
router.post("/inspector", defineEventHandler(create));
router.get("/inspector/:id_inspector", defineEventHandler(detail));
router.put("/inspector/:id_inspector", defineEventHandler(update));
router.delete("/inspector/:id_inspector", defineEventHandler(remove));
